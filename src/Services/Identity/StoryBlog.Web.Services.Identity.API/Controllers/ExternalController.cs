...
namespace StoryBlog.Web.Services.Identity.API.Controllers
{
    ...
    public class ExternalController : Controller
    {
        ...
        private static void ProcessLoginCallbackForOidc(AuthenticateResult result, ICollection<Claim> claims,
        ...
        private static void ProcessLoginCallbackForWsFed(AuthenticateResult result, ICollection<Claim> claims,
            AuthenticationProperties properties)
        {
        }

        private static void ProcessLoginCallbackForSaml2p(AuthenticateResult result, ICollection<Claim> claims,
            AuthenticationProperties properties)
        {
        }
