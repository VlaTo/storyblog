    ...
    public sealed class CompositeDisposable : ICollection<IDisposable>, ICancelable
    {
        ...
        private void Init(IEnumerable<IDisposable> disposables, int capacityHint)
        {
            ...
            foreach (var d in disposables)
            {
                if (null == d)
                {
                    throw new ArgumentException("", nameof(disposables));
                }
            ...
            Volatile.Write(ref count, this.disposables.Count);
        }
        ...
        public IEnumerator<IDisposable> GetEnumerator()
        {
            lock (gate)
            {
                ...
                return new CompositeEnumerator(disposables.ToArray());
            }
        }
