...
namespace StoryBlog.Web.Blazor.OidcClient2
{
    internal sealed class ResponseProcessor
    {
        ...
        private async Task<ResponseValidationResult> ProcessHybridFlowResponseAsync(OidcConstants.AuthorizeResponse authorizeResponse, AuthorizeState state, object extraParameters = null)
        {
        ...
        private async Task<ResponseValidationResult> ProcessCodeFlowResponseAsync(OidcConstants.AuthorizeResponse authorizeResponse, AuthorizeState state, object extraParameters)
        {
        ...
        internal async Task<TokenResponseValidationResult> ValidateTokenResponseAsync(OidcConstants.TokenResponse response, AuthorizeState state, bool requireIdentityToken = true)
        {
        ...
        private async Task<OidcConstants.TokenResponse> RedeemCodeAsync(string code, AuthorizeState state, object extraParameters)
        {
