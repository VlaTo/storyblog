...
namespace StoryBlog.Web.Blazor.OidcClient2.Messages
{
    ...
    public class TokenResponse : Response
    {
        ...
        public TokenResponse(HttpStatusCode statusCode, string reason, string content) 
            : base(statusCode, reason, content)
        {
        }
        ...
        public int ExpiresIn
        {
            get
            {
                ...
                if (value != null && int.TryParse(value, out var theValue))
                {
                    return theValue;
                }
