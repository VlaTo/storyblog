namespace StoryBlog.Web.Blazor.OidcClient2
{
    ...
    public enum BasicAuthenticationHeaderStyle
    {
        ...
        /// <summary>
        /// Uses the encoding as described in the original basic
        /// authentication spec (https://tools.ietf.org/html/rfc2617#section-2 - used by some non-OAuth 2.0
        /// compliant authorization servers). Base64(client_id + ":" + client_secret). 
        /// </summary>
        Rfc2617
    }
}